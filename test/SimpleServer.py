...
class SimpleServer(PyTango.Device_4Impl):
    ...
    def delete_device(self):
        print("[Device delete_device method] for device %s" % self.get_name())

    #------------------------------------------------------------------
    #    Device initialization
    #------------------------------------------------------------------
    def init_device(self):
        print("In %s::init_device()" % self.get_name())
        ...
        self.attr_ScalarEncoded = "UTF8", \
                                  "Hello UTF8! Pr\xc3\xb3ba \xe6\xb5\x8b"
        ...
        self.attr_SpectrumULong = numpy.array([1234, 5678, 45, 345],
                                              dtype='uint32')
        ...
        self.attr_SpectrumEncoded = [
            "INT32",
            "\x00\x01\x03\x04\x20\x31\x43\x54\x10\x11\x13\x14"
        ]
        ...
        self.attr_ImageULong64 = numpy.array([[2, 5], [3, 4]],
                                             dtype='uint64')
    ...
    def always_executed_hook(self):
        print("In %s::always_excuted_hook()" % self.get_name())
    ...
    def read_attr_hardware(self, data):
        print("In %s::read_attr_hardware()" % self.get_name())

    #------------------------------------------------------------------
    #    Read ScalarLong attribute
    #------------------------------------------------------------------
    def read_ScalarLong(self, attr):
        print("In %s::read_ScalarLong()" % self.get_name())
...
#        attr.get_write_value(self.attr_ScalarLong)
    ...
    def write_ScalarBoolean(self, attr):
        print("In %s::write_ScalarBoolean()" % self.get_name())

        #    Add your own code here
        self.attr_ScalarBoolean = attr.get_write_value()
        print("Attribute value = %s" % self.attr_ScalarBoolean)

    #------------------------------------------------------------------
    #    Read ScalarShort attribute
    #------------------------------------------------------------------
    def read_ScalarShort(self, attr):
        print("In %s::read_ScalarShort()" % self.get_name())
    ...
    def write_ScalarShort(self, attr):
        print("In %s::write_ScalarShort()" % self.get_name())

        #    Add your own code here
        self.attr_ScalarShort = attr.get_write_value()
        print("Attribute value = %s" % self.attr_ScalarShort)

    #------------------------------------------------------------------
    #    Read ScalarUShort attribute
    #------------------------------------------------------------------
    def read_ScalarUShort(self, attr):
        print("In %s::read_ScalarUShort()" % self.get_name())
    ...
    def write_ScalarUShort(self, attr):
        print("In %s::write_ScalarUShort()" % self.get_name())

        #    Add your own code here
        self.attr_ScalarUShort = attr.get_write_value()
        print("Attribute value = %s" % self.attr_ScalarUShort)

    #------------------------------------------------------------------
    #    Read ScalarULong attribute
    #------------------------------------------------------------------
    def read_ScalarULong(self, attr):
        print("In %s::read_ScalarULong()" % self.get_name())
    ...
    def write_ScalarULong(self, attr):
        print("In %s::write_ScalarULong()" % self.get_name())

        #    Add your own code here
        self.attr_ScalarULong = attr.get_write_value()
        print("Attribute value = %s" % self.attr_ScalarULong)

    #------------------------------------------------------------------
    #    Read ScalarLong64 attribute
    #------------------------------------------------------------------
    def read_ScalarLong64(self, attr):
        print("In %s::read_ScalarLong64()" % self.get_name())
    ...
    def write_ScalarLong64(self, attr):
        print("In %s::write_ScalarLong64()" % self.get_name())

        #    Add your own code here
        self.attr_ScalarLong64 = attr.get_write_value()
        print("Attribute value = %s" % self.attr_ScalarLong64)
    ...
    def write_ScalarULong64(self, attr):
        print("In %s::write_ScalarULong64()" % self.get_name())

        #    Add your own code here
        self.attr_ScalarULong64 = attr.get_write_value()
        print("Attribute value = %s" % self.attr_ScalarULong64)

    #------------------------------------------------------------------
    #    Read ScalarFloat attribute
    #------------------------------------------------------------------
    def read_ScalarFloat(self, attr):
        print("In %s::read_ScalarFloat()" % self.get_name())
    ...
    def write_ScalarFloat(self, attr):
        print("In %s::write_ScalarFloat()" % self.get_name())

        #    Add your own code here
        self.attr_ScalarFloat = attr.get_write_value()
        print("Attribute value = %s" % self.attr_ScalarFloat)

    #------------------------------------------------------------------
    #    Read ScalarDouble attribute
    #------------------------------------------------------------------
    def read_ScalarDouble(self, attr):
        print("In %s::read_ScalarDouble()" % self.get_name())
    ...
    def write_ScalarDouble(self, attr):
        print("In %s::write_ScalarDouble()" % self.get_name())

        #    Add your own code here
        self.attr_ScalarDouble = attr.get_write_value()
        print("Attribute value = %s" % self.attr_ScalarDouble)

    #------------------------------------------------------------------
    #    Read ScalarString attribute
    #------------------------------------------------------------------
    def read_ScalarString(self, attr):
        print("In %s::read_ScalarString()" % self.get_name())
    ...
    def write_ScalarString(self, attr):
        print("In %s::write_ScalarString()" % self.get_name())

        #    Add your own code here
        self.attr_ScalarString = attr.get_write_value()
        print("Attribute value = %s" % self.attr_ScalarString)

    #------------------------------------------------------------------
    #    Read ScalarEncoded attribute
    #------------------------------------------------------------------
    def read_ScalarEncoded(self, attr):
        print("In %s::read_ScalarEncoded()" % self.get_name())
    ...
    def write_ScalarEncoded(self, attr):
        print("In %s::write_ScalarEncoded()" % self.get_name())

        #    Add your own code here

        self.attr_ScalarEncoded = attr.get_write_value()
        print("Attribute value = %s" % self.attr_ScalarEncoded)

    #------------------------------------------------------------------
    #    Read ScalarUChar attribute
    #------------------------------------------------------------------
    def read_ScalarUChar(self, attr):
        print("In %s::read_ScalarUChar()" % self.get_name())
    ...
    def write_ScalarUChar(self, attr):
        print("In %s::write_ScalarUChar()" % self.get_name())
        #    Add your own code here
        self.attr_ScalarUChar = attr.get_write_value()
        print("Attribute value = %s" % self.attr_ScalarUChar)

    #------------------------------------------------------------------
    #    Read SpectrumEncoded attribute
    #------------------------------------------------------------------
    def read_SpectrumEncoded(self, attr):
        print("In %s::read_SpectrumEncoded()" % self.get_name())
    ...
    def write_SpectrumEncoded(self, attr):
        print("In %s::write_SpectrumEncoded()" % self.get_name())

        #    Add your own code here
        self.attr_SpectrumEncoded = attr.get_write_value()
        print("Attribute value = %s" % self.attr_SpectrumEncoded)

    #------------------------------------------------------------------
    #    Read ImageEncoded attribute
    #------------------------------------------------------------------
    def read_ImageEncoded(self, attr):
        print("In %s::read_ImageEncoded()" % self.get_name())
    ...
    def write_ImageEncoded(self, attr):
        print("In %s::write_ImageEncoded()" % self.get_name())

        #    Add your own code here
        self.attr_ImageEncoded = attr.get_write_value()
        print("Attribute value = %s" % self.attr_ImageEncoded)

    #------------------------------------------------------------------
    #    Read SpectrumBoolean attribute
    #------------------------------------------------------------------
    def read_SpectrumBoolean(self, attr):
        print("In %s::read_SpectrumBoolean()" % self.get_name())
    ...
    def write_SpectrumBoolean(self, attr):
        print("In %s::write_SpectrumBoolean()" % self.get_name())

        #    Add your own code here
        self.attr_SpectrumBoolean = attr.get_write_value()
        print("Attribute value = %s" % self.attr_SpectrumBoolean)

    #------------------------------------------------------------------
    #    Read SpectrumUChar attribute
    #------------------------------------------------------------------
    def read_SpectrumUChar(self, attr):
        print("In %s::read_SpectrumUChar()" % self.get_name())
    ...
    def write_SpectrumUChar(self, attr):
        print("In %s::write_SpectrumUChar()" % self.get_name())

        #    Add your own code here
        self.attr_SpectrumUChar = attr.get_write_value()
        print("Attribute value = %s" % self.attr_SpectrumUChar)

    #------------------------------------------------------------------
    #    Read SpectrumShort attribute
    #------------------------------------------------------------------
    def read_SpectrumShort(self, attr):
        print("In %s::read_SpectrumShort()" % self.get_name())
    ...
    def write_SpectrumShort(self, attr):
        print("In %s::write_SpectrumShort()" % self.get_name())

        #    Add your own code here
        self.attr_SpectrumShort = attr.get_write_value()
        print("Attribute value = %s" % self.attr_SpectrumShort)

    #------------------------------------------------------------------
    #    Read SpectrumUShort attribute
    #------------------------------------------------------------------
    def read_SpectrumUShort(self, attr):
        print("In %s::read_SpectrumUShort()" % self.get_name())
    ...
    def write_SpectrumUShort(self, attr):
        print("In %s::write_SpectrumUShort()" % self.get_name())

        #    Add your own code here
        self.attr_SpectrumUShort = attr.get_write_value()
        print("Attribute value = %s" % self.attr_SpectrumUShort)

    #------------------------------------------------------------------
    #    Read SpectrumLong attribute
    #------------------------------------------------------------------
    def read_SpectrumLong(self, attr):
        print("In %s::read_SpectrumLong()" % self.get_name())
    ...
    def write_SpectrumLong(self, attr):
        print("In %s::write_SpectrumLong()" % self.get_name())

        #    Add your own code here
        self.attr_SpectrumLong = attr.get_write_value()
        print("Attribute value = %s" % self.attr_SpectrumLong)

    #------------------------------------------------------------------
    #    Read SpectrumULong attribute
    #------------------------------------------------------------------
    def read_SpectrumULong(self, attr):
        print("In %s::read_SpectrumULong()" % self.get_name())
    ...
    def write_SpectrumULong(self, attr):
        print("In %s::write_SpectrumULong()" % self.get_name())

        #    Add your own code here
        self.attr_SpectrumULong = attr.get_write_value()
        print("Attribute value = %s" % self.attr_SpectrumULong)

    #------------------------------------------------------------------
    #    Read SpectrumLong64 attribute
    #------------------------------------------------------------------
    def read_SpectrumLong64(self, attr):
        print("In %s::read_SpectrumLong64()" % self.get_name())
    ...
    def write_SpectrumLong64(self, attr):
        print("In %s::write_SpectrumLong64()" % self.get_name())

        #    Add your own code here
        self.attr_SpectrumLong64 = attr.get_write_value()
        print("Attribute value = %s" % self.attr_SpectrumLong64)

    #------------------------------------------------------------------
    #    Read SpectrumULong64 attribute
    #------------------------------------------------------------------
    def read_SpectrumULong64(self, attr):
        print("In %s::read_SpectrumULong64()" % self.get_name())
    ...
    def write_SpectrumULong64(self, attr):
        print("In %s::write_SpectrumULong64()" % self.get_name())

        #    Add your own code here
        self.attr_SpectrumULong64 = attr.get_write_value()
        print("Attribute value = %s" % self.attr_SpectrumULong64)

    #------------------------------------------------------------------
    #    Read SpectrumFloat attribute
    #------------------------------------------------------------------
    def read_SpectrumFloat(self, attr):
        print("In %s::read_SpectrumFloat()" % self.get_name())
    ...
    def write_SpectrumFloat(self, attr):
        print("In %s::write_SpectrumFloat()" % self.get_name())

        #    Add your own code here
        self.attr_SpectrumFloat = attr.get_write_value()
        print("Attribute value = %s" % self.attr_SpectrumFloat)

    #------------------------------------------------------------------
    #    Read SpectrumDouble attribute
    #------------------------------------------------------------------
    def read_SpectrumDouble(self, attr):
        print("In %s::read_SpectrumDouble()" % self.get_name())
    ...
    def write_SpectrumDouble(self, attr):
        print("In %s::write_SpectrumDouble()" % self.get_name())

        #    Add your own code here
        self.attr_SpectrumDouble = attr.get_write_value()
        print("Attribute value = %s" % self.attr_SpectrumDouble)

    #------------------------------------------------------------------
    #    Read SpectrumString attribute
    #------------------------------------------------------------------
    def read_SpectrumString(self, attr):
        print("In %s::read_SpectrumString()" % self.get_name())
    ...
    def write_SpectrumString(self, attr):
        print("In %s::write_SpectrumString()" % self.get_name())

        #    Add your own code here
        self.attr_SpectrumString = attr.get_write_value()
        print("Attribute value = %s" % self.attr_SpectrumString)

    #------------------------------------------------------------------
    #    Read ImageBoolean attribute
    #------------------------------------------------------------------
    def read_ImageBoolean(self, attr):
        print("In %s::read_ImageBoolean()" % self.get_name())
    ...
    def write_ImageBoolean(self, attr):
        print("In %s::write_ImageBoolean()" % self.get_name())
        #    Add your own code here
        self.attr_ImageBoolean = attr.get_write_value()
        print("Attribute value = %s" % self.attr_ImageBoolean)

    #------------------------------------------------------------------
    #    Read ImageUChar attribute
    #------------------------------------------------------------------
    def read_ImageUChar(self, attr):
        print("In %s::read_ImageUChar()" % self.get_name())
    ...
    def write_ImageUChar(self, attr):
        print("In %s::write_ImageUChar()" % self.get_name())
        self.attr_ImageUChar = attr.get_write_value()
        print("Attribute value = %s" % self.attr_ImageUChar)
    ...
    def read_ImageShort(self, attr):
        print("In %s::read_ImageShort()" % self.get_name())
    ...
    def write_ImageShort(self, attr):
        print("In %s::write_ImageShort()" % self.get_name())
        #    Add your own code here
        self.attr_ImageShort = attr.get_write_value()
        print("Attribute value = %s" % self.attr_ImageShort)

    #------------------------------------------------------------------
    #    Read ImageUShort attribute
    #------------------------------------------------------------------
    def read_ImageUShort(self, attr):
        print("In %s::read_ImageUShort()" % self.get_name())
    ...
    def write_ImageUShort(self, attr):
        print("In %s::write_ImageUShort()" % self.get_name())

        #    Add your own code here
        self.attr_ImageUShort = attr.get_write_value()
        print("Attribute value = %s" % self.attr_ImageUShort)

    #------------------------------------------------------------------
    #    Read ImageLong attribute
    #------------------------------------------------------------------
    def read_ImageLong(self, attr):
        print("In %s::read_ImageLong()" % self.get_name())
    ...
    def write_ImageLong(self, attr):
        print("In %s::write_ImageLong()" % self.get_name())

        #    Add your own code here
        self.attr_ImageLong = attr.get_write_value()
        print("Attribute value = %s" % self.attr_ImageLong)

    #------------------------------------------------------------------
    #    Read ImageULong attribute
    #------------------------------------------------------------------
    def read_ImageULong(self, attr):
        print("In %s::read_ImageULong()" % self.get_name())
    ...
    def write_ImageULong(self, attr):
        print("In %s::write_ImageULong()" % self.get_name())

        #    Add your own code here
        self.attr_ImageULong = attr.get_write_value()
        print("Attribute value = %s" % self.attr_ImageULong)

    #------------------------------------------------------------------
    #    Read ImageLong64 attribute
    #------------------------------------------------------------------
    def read_ImageLong64(self, attr):
        print("In %s::read_ImageLong64()" % self.get_name())
    ...
    def write_ImageLong64(self, attr):
        print("In %s::write_ImageLong64()" % self.get_name())
        #    Add your own code here
        self.attr_ImageLong64 = attr.get_write_value()
        print("Attribute value = %s" % self.attr_ImageLong64)

    #------------------------------------------------------------------
    #    Read ImageULong64 attribute
    #------------------------------------------------------------------
    def read_ImageULong64(self, attr):
        print("In %s::read_ImageULong64()" % self.get_name())
    ...
    def write_ImageULong64(self, attr):
        print("In %s::write_ImageULong64()" % self.get_name())

        #    Add your own code here
        self.attr_ImageULong64 = attr.get_write_value()
        print("Attribute value = %s" % self.attr_ImageULong64)

    #------------------------------------------------------------------
    #    Read ImageFloat attribute
    #------------------------------------------------------------------
    def read_ImageFloat(self, attr):
        print("In %s::read_ImageFloat()" % self.get_name())
    ...
    def write_ImageFloat(self, attr):
        print("In %s::write_ImageFloat()" % self.get_name())

        #    Add your own code here
        self.attr_ImageFloat = attr.get_write_value()
        print("Attribute value = %s" % self.attr_ImageFloat)

    #------------------------------------------------------------------
    #    Read ImageDouble attribute
    #------------------------------------------------------------------
    def read_ImageDouble(self, attr):
        print("In %s::read_ImageDouble()" % self.get_name())
    ...
    def write_ImageDouble(self, attr):
        print("In %s::write_ImageDouble()" % self.get_name())

        #    Add your own code here
        self.attr_ImageDouble = attr.get_write_value()
        print("Attribute value = %s" % self.attr_ImageDouble)

    #------------------------------------------------------------------
    #    Read ImageString attribute
    #------------------------------------------------------------------
    def read_ImageString(self, attr):
        print("In %s::read_ImageString()" % self.get_name())
    ...
    def write_ImageString(self, attr):
        print("In %s::write_ImageString()" % self.get_name())

        #    Add your own code here
        self.attr_ImageString = attr.get_write_value()
        print("Attribute value = %s" % self.attr_ImageString)
    ...
    #------------------------------------------------------------------
    def GetBoolean(self):
        print("In %s::GetBoolean()" % self.get_name())
        #    Add your own code here
    ...
    #------------------------------------------------------------------
    def GetShort(self):
        print("In %s::GetShort()" % self.get_name())
        #    Add your own code here
    ...
    #------------------------------------------------------------------
    def GetLong(self):
        print("In %s::GetLong()" % self.get_name())
        #    Add your own code here
    ...
    #------------------------------------------------------------------
    def GetLong64(self):
        print("In %s::GetLong64()" % self.get_name())
        #    Add your own code here
    ...
    #------------------------------------------------------------------
    def GetFloat(self):
        print("In %s::GetFloat()" % self.get_name())
        #    Add your own code here
    ...
    #------------------------------------------------------------------
    def GetDouble(self):
        print("In %s::GetDouble()" % self.get_name())
        #    Add your own code here
    ...
    #------------------------------------------------------------------
    def GetUShort(self):
        print("In %s::GetUShort()" % self.get_name())
        #    Add your own code here
    ...
    #------------------------------------------------------------------
    def GetULong(self):
        print("In %s::GetULong()" % self.get_name())
        #    Add your own code here
    ...
    #------------------------------------------------------------------
    def GetULong64(self):
        print("In %s::GetULong64()" % self.get_name())
        #    Add your own code here
    ...
    #------------------------------------------------------------------
    def GetString(self):
        print("In %s::GetString()" % self.get_name())
        #    Add your own code here
