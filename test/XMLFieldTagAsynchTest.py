...
## test fixture
class XMLFieldTagAsynchTest(XMLFieldTagWriterTest.XMLFieldTagWriterTest):
    ## server counter
    serverCounter = 0
    ## constructor
    ...
    def __init__(self, methodName):
        ...
        sins = self.__class__.__name__+"%s" % XMLFieldTagAsynchTest.serverCounter
