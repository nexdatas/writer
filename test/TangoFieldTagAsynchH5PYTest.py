...
## test fixture
class TangoFieldTagAsynchH5PYTest(TangoFieldTagWriterH5PYTest.TangoFieldTagWriterH5PYTest):
    ## server counter
    serverCounter = 0
    ...
    def __init__(self, methodName):
        ...
        sins = self.__class__.__name__+"%s" % TangoFieldTagAsynchH5PYTest.serverCounter
