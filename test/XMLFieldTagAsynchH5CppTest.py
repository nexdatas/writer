...
# \file XMLFieldTagAsynchH5CppTest.py
...
# test fixture
class XMLFieldTagAsynchH5CppTest(XMLFieldTagWriterH5CppTest.XMLFieldTagWriterH5CppTest):
    # server counter
    serverCounter = 0
    # constructor
    ...
    def __init__(self, methodName):
        XMLFieldTagWriterH5CppTest.XMLFieldTagWriterH5CppTest.__init__(
            self, methodName)

        XMLFieldTagAsynchH5CppTest.serverCounter += 1
        sins = self.__class__.__name__ + \
            "%s" % XMLFieldTagAsynchH5CppTest.serverCounter
