...
# \file XMLFieldTagAsynch_test.py
...
# test fixture
class XMLFieldTagAsynchTest(XMLFieldTagWriter_test.XMLFieldTagWriterTest):
    # server counter
    serverCounter = 0
    # constructor
    ...
    def __init__(self, methodName):
        XMLFieldTagWriter_test.XMLFieldTagWriterTest.__init__(self, methodName)

        XMLFieldTagAsynchTest.serverCounter += 1
        sins = self.__class__.__name__ + \
            "%s" % XMLFieldTagAsynchTest.serverCounter
