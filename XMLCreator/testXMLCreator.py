...
#	mot1 = NDeviceGroup(ins.elem, "p09/motor/exp.01", "motor1", "NXpositioner", commands=False)
	mot1 = NDeviceGroup(ins.elem, "p09/motor/exp.01", "motor1", "NXpositioner", commands=False,\
				 blackAttrs = ["PositionEncoder", "PositionEncoderRaw"])
	mot2 = NDeviceGroup(ins.elem, "p09/motor/exp.02", "motor2", "NXpositioner", commands=False,\
				 blackAttrs = ["PositionEncoder", "PositionEncoderRaw"])
	mca = NDeviceGroup(ins.elem, "p09/mca/exp.02", "mca2", "NXdetector")
	cnt = NDeviceGroup(ins.elem, "p09/counter/exp.02", "counter", "NXmonitor")
	dac = NDeviceGroup(ins.elem, "p09/dac/exp.02", "dac", "NXsensor")
	adc = NDeviceGroup(ins.elem, "p09/adc/exp.02", "adc", "NXsensor")
	vfc = NDeviceGroup(ins.elem, "p09/vfc/exp.02", "vfcadc", "NXsensor")
	dgg2 = NDeviceGroup(ins.elem, "p09/dgg2/exp.01", "dgg2", "NXmonitor")
	tst = NGroup(en.elem, "tst", "NXinstrument")
	mot1.setText("My motor1")
	mot2.setText("My motor1")

	KKK = NDeviceGroup(tst.elem, "p09/tst/exp.01", "Tst", "NXmonitor")
